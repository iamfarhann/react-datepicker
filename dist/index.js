...
var subDays = _interopDefault(require("date-fns/subDays")),
  ...
  dfgetWeek = _interopDefault(require("date-fns/getWeek")),
...
function getWeek(e, t) {
  ...
  return dfgetWeek(e, r ? { locale: r } : null);
}
      ...
      return (
        ...
        _defineProperty(_assertThisInitialized(r), "getAriaLabel", function() {
          var e = r.props,
            ...
            s = r.isDisabled() || r.isExcluded() ? i : a;
          return "".concat(s, " ").concat(formatDate(t, "PPPP"));
        }),
          ...
          value: function() {
            ...
            return React.createElement(
              "div",
              {
                ...
                role: "listbox",
                "aria-label": "".concat(o, " ").concat(formatDate(n, "yyyy-MM"))
              },
              t
                ? this.renderMonths()
                : r
            ...
            if (!r.props.renderCustomHeader) {
              ...
              if (
                ...
                var a =
                  ...
                  s = void 0 === i ? "Previous Month" : i,
                  p = o.previousYearAriaLabel,
                  c = void 0 === p ? "Previous Year" : p;
                return React.createElement(
                  "button",
                  {
                    type: "button",
            ...
            if (!r.props.renderCustomHeader) {
              ...
              if (
                ...
                var a =
                  ...
                  s = void 0 === i ? "Next Month" : i,
                  p = o.nextYearAriaLabel,
                  c = void 0 === p ? "Next Year" : p;
                return React.createElement(
                  "button",
                  {
                    type: "button",
